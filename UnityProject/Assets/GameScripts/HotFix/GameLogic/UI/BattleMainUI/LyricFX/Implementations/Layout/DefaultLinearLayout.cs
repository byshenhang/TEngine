...
namespace LyricFX.Implementations.Layout
{
    ...
    /// 默认线性布局 - 将字符按水平方向排列
    /// </summary>
    public class DefaultLinearLayout : MonoBehaviour, ILayoutProvider
    {
        [SerializeField] private float characterSpacing = 0.5f;  // 字符间距
        [SerializeField] private Vector3 startOffset = Vector3.zero;  // 起始偏移
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                characterSpacing = linearConfig.CharacterSpacing;
                startOffset = linearConfig.StartOffset;
            }
            ...
            for (int i = 0; i < text.Length; i++)
            {
                ...
                // 移动到下一个字符位置
                currentPos += new Vector3(characterSpacing, 0, 0);
